...
export interface TokenizedIDAInterface extends utils.Interface {
  functions: {
    ...
    "getUnitsHeld(address)": FunctionFragment;
...
export interface TokenizedIDA extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenizedIDAInterface;
